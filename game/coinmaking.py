...
class mainapplication:
    def __init__(self, para):
        ...
        self.coin_img = PhotoImage(file = "removed.png")
    ...
    def thegame(self):
        ...
        game_canvas.create_image(250,26,image = self.coin_img)
    ...
    #global player,score,e, game, counter_pause
    #print(player)
    ...
    def coins(self):
        self.coin = game_canvas.create_image(799, 480, image=self.coin_img)
    ...
    def coin_movement(self):
        ...
        game_canvas.move(self.coin, self.speed, 0)
        if game_canvas.coords(self.coin)[0] <= -50:
            game_canvas.delete(self.coin)
            self.coins()
        self.moving_coins = game_canvas.after(8, self.coin_movement)
        if self.collision(game_canvas.coords(self.character), game_canvas.coords(self.coin)):
            game_canvas.delete(self.coin)
            self.coins()
